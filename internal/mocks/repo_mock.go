...
// Source: ova-exam-api/internal/repo (interfaces: Repo)

// Package mocks is a generated GoMock package.
package mocks

import (
	user "ova-exam-api/internal/domain/entity/user"
	reflect "reflect"
...
func (m *MockRepo) AddEntities(arg0 []user.User) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]user.User, error) {
	m.ctrl.T.Helper()
